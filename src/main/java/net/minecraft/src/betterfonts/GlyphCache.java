...
public class GlyphCache
{
	 ...
	 */
	public static final List<Font> allFonts = Arrays.asList(GraphicsEnvironment.getLocalGraphicsEnvironment().getAllFonts());
	...
	{
		Log.i("BetterFonts loading font \"" + name + "\"");
		usedFonts.clear();
	...
	Font lookupFont(char text[], int start, int limit, int style)
	{
		...
		while (iterator.hasNext())
		{
			...
			if (font.canDisplayUpTo(text, start, limit) != start)
			{
				 ...
				 */
				Log.i("BetterFonts loading font \"" + font.getFontName() + "\"");
				usedFonts.add(font);
