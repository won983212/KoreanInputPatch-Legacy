...
import kp.wrapper.GuiTextfieldWrapper.PrivateMethodAccessor;
...
public class GuiTextField extends Gui implements PrivateMethodAccessor
{
	...
	// kp
	private GuiTextfieldWrapper wrapper;
	...
	public GuiTextField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height)
	{
		...
		// kp
		wrapper = new GuiTextfieldWrapper(this);
	}
	...
	{/*if (!this.isFocused)
		...
		// kp
		return wrapper.keyTyped(typedChar, keyCode);
	}
	...
	public void drawTextBox()
	{
		if (this.getVisible())
		{
			...
			// kp
			wrapper.draw(l, i1, lineScrollOffset);
		}
	}
	...
	{
		return this.wrapper.getCursorPosition();
	}

	public void setCursorPos(int var1)
	{
		this.wrapper.setCursorPosition(var1);
	}
	...
	public void setTargetText(String var1)
	{
		this.wrapper.setText(var1);
	}
	...
	{
		return this.wrapper.hanjain;
	}

	public ColorChooserInput getColorInput()
	{
		return this.wrapper.colorin;
	}
}