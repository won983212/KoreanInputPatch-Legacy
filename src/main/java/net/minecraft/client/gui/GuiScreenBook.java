...
public class GuiScreenBook extends GuiScreen implements Inputer
{
	...
	private ColorChooserInput colorin;
	private HanjaInput hanjain;
	// end kp
	...
	public GuiScreenBook(EntityPlayer player, ItemStack book, boolean isUnsigned)
	{
		...
		this.kr.setMaxlen(255);

		this.colorin = new ColorChooserInput();
		this.colorin.setPrefix('§');
		this.colorin.setUseFollowing(false);
	...
	protected void keyTyped(char typedChar, int keyCode) throws IOException
	{
		...
		// start kp
		if (this.colorin.typed(this, typedChar, keyCode))
			return;
		if (this.hanjain.typed(this, typedChar, keyCode))
			return;
		// end kp
	...
	private void keyTypedInBook(char typedChar, int keyCode)
	{
		...
		else
		{
			...
			{
				/*
				 * case 14: String s = this.pageGetCurrent();
				 * 
				 * if (!s.isEmpty()) { this.pageSetCurrent(s.substring(0, s.length() - 1)); }
				 * 
				 * return;
				 */
				// kp: KoreanInput includes backspace.
				case 28:
				case 156:
				...
				default:
					 ...
					 */ // kp: KoreanInput includes default case.
			}
		}
	}
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks)
	{
		...
		// start kp
		this.colorin.draw(this, this, this.fontRenderer);
		this.hanjain.draw(this, this, this.fontRenderer);
		// end kp
	...
	{
		return this.bookGettingSigned ? this.bookTitle : pageGetCurrent();
	}
